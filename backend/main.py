...
class ConfigManager:
    ...
    def generate_example_config(
            output_path: str = "example_config.json") -> None:
    ...
    def validate_config(config: Dict[str, Any]) -> bool:
        ...
        required_sections = [
            'salary', 'bonuses', 'stock_grants', 'tax_settings', 'expenses'
        ]
...
def main():
    parser = argparse.ArgumentParser(
        description='UK Salary Budgeting Calculator')
    parser.add_argument('--config',
                        type=str,
                        help='Path to configuration file')
    parser.add_argument('--generate-example',
                        action='store_true',
